...
<body class="bg-dark">
    ...
    <div class="splash-container">
        <div class="card">
            <div class="card-header bg-primary text-center"><a class="navbar-brand text-white" href="#"><img src="<?= base_url(); ?>assets/images/logos.png" alt="User Avatar" width="100px"></a><span class="splash-description">Employee Management</span></div>
