                    							...
                    							<div class="user-avatar-address">
                    								<p class="border-bottom pb-3">
                    									<span class="d-xl-inline-block d-block mb-2"><i
                    											class="fa fa-map-marker-alt mr-2 text-primary "></i>Bekasi Raya</span>
                    								</p>
                    								<div class="mt-3">
														<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Inventore sed nam hic quibusdam delectus nulla vel temporibus earum odio reiciendis.</p>
                    								</div>
                    							</div>
                    						</div>
                    					</div>
